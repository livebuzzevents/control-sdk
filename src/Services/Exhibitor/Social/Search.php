 ...
 * Class Search
 *
 * @package Buzz\Control\Services\Exhibitor\Social
 */
class Search implements Service
{
    ...
    {
        return "exhibitor/{$this->exhibitor->getId()}/social";
    }
    ...
    public function decorate($response)
    {
        ...
        foreach ($response as $key => $social) {
            $decorated[$key] = Social::createFromArray($social);
        }
